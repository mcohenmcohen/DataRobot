...
def create_payoff_function(tn, fn, tp, fp, *args, **kwargs):
    ...
    print(args)
    print(kwargs)
    print('in create_payoff_function')

    # See https://www.protechtraining.com/content/python_fundamentals_tutorial-functional_programming
    # - 13.5 Nested functions
    def payoff_function(roc_point):
        # print('roc_point:', roc_point)
