...
class ElmoEmbeddingLayer(Layer):
    ...
    def build(self, input_shape):
        self.elmo = hub.Module('https://tfhub.dev/google/universal-sentence-encoder/2', trainable=self.trainable, name="{}_module".format(self.name))
...
t1 = time()
diag_enc = model.predict(string_data, batch_size=4096)
t2 = time()
print(t2-t1)
