...
EU <- fread('~/workspace/data-science-scripts/zach/otv_nolag_results.csv')
EU <- EU[,list(
  dataset = dataset_name,
  `Prediction Gini Norm` = pred_gini
)]
...
diffdat <- merge(DR[,list(dataset, DataRobot.Pred.Gini)], diffdat, all=T)
...
ggplot(all, aes(x=method, y=`Prediction.Gini.Norm`)) + geom_boxplot() + theme_bw()
```
