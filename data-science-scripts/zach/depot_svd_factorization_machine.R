...
# Load raw data
train_raw <- fread('https://s3.amazonaws.com/datarobot_public_datasets/Depot_text_cosine_sim_80.csv')
test_raw <- fread('https://s3.amazonaws.com/datarobot_public_datasets/Depot_text_cosine_sim_20.csv')
...
# Best Kaggle: 0.43192  DR: 0.4739548
rmse(train_target, p_train)
rmse(test_target, p_test)
