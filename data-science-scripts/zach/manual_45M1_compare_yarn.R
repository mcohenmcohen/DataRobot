...
old_mbtest_ids <- c(
  '5bf3e8b77347c90028d486fa',  # (132 pass, 7 failed, 2 bugs)
  '5bfd9cd13e8ed20001cf28ff',  # Time series additions, not in original test (17 passed, 14 failed)
  '5c002c33ded00d0001932dde',  # (18 passed, 3 failed)
  '5c06ecbfd32a5b0001d134b5',  # (2 passed, 1 failed)
  '5c093b5ff4ebdd0001a3e7bc',  # (1 passed)
  '5c0a8c0898794e000146fc11',  #, Updated milliseconds rerun, running
  '5bf331a57763db000165fc61',  # (11 pass, 6 failed)
  '5bf5709df1ada70001b820ef',  # (5 passed, 1 failed)
  '5bfd9cd2d50b3c0001247589',  # Time series additions (2 passed, 3 failed)
  '5bfd9d05d50b3c0001519ff2',  # Scaleout only (3 passed)
  '5c08294c32af9e000131b031'  # (3 passed)
  )
new_mbtest_ids <- c(
...
stopifnot(dat_old[,all(Metablueprint=='Metablueprint v12.0.02-so' | Metablueprint=='')])
...
res_normal
res_ts
res_normal[Filename == 'food101_small.csv',]
...
dat[Filename=='cats_dogs_small_train.csv' & run == old_release,][which.max(Total_Time_P1), main_task]
dat[Filename=='cats_dogs_small_train.csv' & run == new_release,][which.max(Total_Time_P1), main_task]
