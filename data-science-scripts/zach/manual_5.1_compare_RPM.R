...
old_mbtest_ids <- c(
  '5c759508fa87c80001704313',
  '5c7815cdd98dfe0001851b7c',
  '5c7dbc7803f9870001f750f3'
  )
new_mbtest_ids <- c(
  '5ce59beb1ca1ec0001d97a79',
  '5cf1761ba00ee300017a12a2',
  '5cf69ed7572f5700018e4c24',
  '5cfe68fcb7815d00012a99cd'  
)
...
x <- 'UNIX_user_data_v1.csv'
dat[Filename==x & run == old_release,][which.max(Max_RAM_GB), target_type]
...
dat[Filename==x & run == old_release,][which.max(Total_Time_P1_Hours), Blueprint]
dat[Filename==x & run == new_release,][which.max(Total_Time_P1_Hours), Blueprint]

x <- 'BachChoralHarmony_v1_83_classes.csv'
