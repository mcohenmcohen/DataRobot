...
old_mbtest_ids <- c(
  '5ce7e7ad6f435d0001b9ddd3',
  '5cf17ccae3e18200012b1198',
  '5cf69e67572f570001168dcc',
  '5cfe6958b7815d0001be4903',
  '5ce59a53de57df000126e58f',
  '5cfbb3c47347c9002852d461',
  '5cfd9a6f7347c9002bb11258'
)
new_mbtest_ids <- c(
...
# Plot MASE_H by model - TS
var = 'MASE_H'
ggplot(res[variable == var & !is.na(diff),], aes_string(x=old_release, y=new_release, color='Y_Type')) + 
  geom_point() + geom_abline(slope=1, intercept=0) + 
  facet_wrap(~model, scales='free') + 
  theme_bw() + theme_tufte() + ggtitle(paste(test, old_release, 'vs', new_release, var))
